...
**Phase 4: Manual follow-up.** Active scan finds candidates, not confirmed exploits. Verify each finding by hand before reporting. When a client needs that manual depth but you don't want to staff it, [white-label penetration testing](/msp-pentesting) picks up where automated scans stop.
