      ...
      <div className="max-w-4xl mx-auto px-5 py-20 space-y-12">
        <div className="space-y-4">
          ...
          <p className="text-[#8fa8c8] text-lg max-w-2xl">
            Automated web-layer security baseline for common app-level risk.
            Crawler-based passive analysis for web applications.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 gap-4">
          <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl p-4">
            ...
            <span className="text-sm">Automated web security baseline</span>
          </div>
          <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl p-4">
            <svg
              className="w-5 h-5 text-[#0366d6] shrink-0"
            ...
            <span className="text-sm">Crawler + passive analysis</span>
          </div>
          <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl p-4">
            <svg
              className="w-5 h-5 text-[#0366d6] shrink-0"
          ...
          <div className="flex items-center gap-3 bg-white/5 border border-white/10 rounded-xl p-4">
            ...
            <span className="text-sm">Easy report handoff</span>
          </div>
        </div>
