...
const jsonLd = jsonLdString(
  breadcrumbJsonLd([
    ...
    { name: "Nmap", url: "/scanners/nmap" },
  ]),
  scannerServiceJsonLd({
    name: "Hosted Nmap Port Scanner",
    description:
      "Run Nmap port and service scans on hosted infrastructure. TCP/UDP scanning, version detection, OS fingerprinting, and the Nmap Scripting Engine — with a PDF report per scan.",
    slug: "nmap",
    serviceType: "Network vulnerability scanning",
  }),
);
      ...
      <div className="max-w-5xl mx-auto px-5 py-20 space-y-20">
        ...
        <header className="space-y-6">
          ...
          <h1 className="text-4xl lg:text-5xl font-medium tracking-tight leading-[1.05]">
            Nmap Port Scanner.
            <br />
            <span className="text-[#9aa5b6]">Hosted. Zero install.</span>
          </h1>
